...
function onConfirmWhenAddEditForStripe() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/StripeSettingsUpdate',
...
function onConfirmWhenAddEditForPaypal() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/PaypalSettingsUpdate',
...
function onConfirmWhenAddEditForRazorpay() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/RazorpaySettingsUpdate',
...
function onConfirmWhenAddEditForMollie() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/MollieSettingsUpdate',
...
function onConfirmWhenAddEditForCOD() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/CODSettingsUpdate',
...
function onConfirmWhenAddEditForBank() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/BankSettingsUpdate',
