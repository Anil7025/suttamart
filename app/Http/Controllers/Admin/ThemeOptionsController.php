...
class ThemeOptionsController extends Controller
{
    ...
    public function getThemeOptionsPageLoad() {
		...
		$datalist = $data;
        return view('admin.theme-options', compact('datalist'));
    }
    ...
    public function getThemeOptionsHeaderPageLoad() {
        ...
        return view('admin.theme-options-header', compact('datalist', 'statuslist'));
    }
    ...
    public function getThemeOptionsFooterPageLoad() {
        ...
        return view('admin.theme-options-footer', compact('datalist','statuslist'));
    }
    ...
    public function getThemeOptionsSEOPageLoad() {
        ...
        return view('admin.theme-options-seo', compact('datalist','statuslist'));
    }
    ...
    public function getThemeOptionsColorPageLoad() {
        ...
        return view('admin.theme-options-color', compact('datalist'));
    }
    ...
    public function getThemeOptionsFacebookPageLoad() {
        ...
        return view('admin.theme-options-facebook', compact('datalist', 'statuslist'));
    }
    ...
    public function getThemeOptionsFacebookPixelLoad() {
        ...
        return view('admin.theme-options-facebook-pixel', compact('datalist', 'statuslist'));
    }
    ...
    public function getThemeOptionsTwitterPageLoad() {
        ...
        return view('admin.theme-options-twitter', compact('datalist', 'statuslist'));
    }
    ...
    public function getGoogleAnalytics() {
        ...
        return view('admin.google-analytics', compact('datalist', 'statuslist'));
    }
    ...
    public function getGoogleTagManager() {
        ...
        return view('admin.google-tag-manager', compact('datalist', 'statuslist'));
    }
    ...
    public function getThemeOptionsWhatsappPageLoad() {
        ...
        return view('admin.theme-options-whatsapp', compact('datalist', 'statuslist'));
    }
    ...
    public function getThemeOptionsHomeVideo() {
        ...
        return view('admin.home-video', compact( 'datalist', 'statuslist'));
    }
    ...
    public function getPageVariation() {
        ...
        return view('admin.page-variation', compact('datalist'));
    }
    ...
    public function getCookieConsent() {
        ...
        return view('admin.cookie-consent', compact('datalist', 'statuslist'));
    }
