...
$(function () {
	...
	$(document).on("click", ".MenuSettingsSubmitForm", function(event) {
		...
		$.ajax({
			type : 'POST',
			url: base_url + '/admin/UpdateMenuSettings',
	...
	$(document).on("click", ".DeleteParentChildMenu", function(event) {
		...
		$.ajax({
			type : 'POST',
			url: base_url + '/admin/deleteParentChildMenu',
...
function onSortableItemList() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/UpdateSortableMenuList',
...
function onPageMenuBuilderPagination(page) {
	...
	$.ajax({
		url: base_url + "/admin/getPageMenuBuilderData?page="+page+"&lan="+main_menu_lan+"&id="+main_menu_id+"&search="+search_page_menu,
...
function onPageMenuBuilderSearch() {
	var search_page_menu = $("#search_page_menu").val();
	$.ajax({
		url: base_url + "/admin/getPageMenuBuilderData?search="+search_page_menu+"&lan="+main_menu_lan+"&id="+main_menu_id,
		success:function(data){
			$('#page_menu_builder_id').html(data);
			onPageCheckAll();
		}
...
function submitPageMenu() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/SaveParentMenu',
...
function onBrandMenuBuilderPagination(page) {
	...
	$.ajax({
		url: base_url + "/admin/getBrandMenuBuilderData?page="+page+"&lan="+main_menu_lan+"&id="+main_menu_id+"&search="+search_brand_menu,
		success:function(data){
...
function onBrandMenuBuilderSearch() {
	var search_brand_menu = $("#search_brand_menu").val();
	$.ajax({
		url: base_url + "/admin/getBrandMenuBuilderData?search="+search_brand_menu+"&lan="+main_menu_lan+"&id="+main_menu_id,
		success:function(data){
			$('#category_menu_builder_id').html(data);
			onBrandCheckAll();
		}
...
function onProductMenuBuilderPagination(page) {
	...
	$.ajax({
		url: base_url + "/admin/getProductMenuBuilderData?page="+page+"&lan="+main_menu_lan+"&id="+main_menu_id+"&search="+search,
		success:function(data){
...
function onProductMenuBuilderSearch() {
	var search = $("#search_product_menu").val();
	$.ajax({
		url: base_url + "/admin/getProductMenuBuilderData?search="+search+"&lan="+main_menu_lan+"&id="+main_menu_id,
		success:function(data){
			$('#product_menu_builder_id').html(data);
			onProductCheckAll();
		}
...
function onProductCategoryMenuBuilderPagination(page) {
	...
	$.ajax({
		url: base_url + "/admin/getProductCategoryMenuBuilderData?page="+page+"&lan="+main_menu_lan+"&id="+main_menu_id+"&search="+search,
		success:function(data){
...
function onProductCategoryMenuBuilderSearch() {
	var search = $("#search_product_category_menu").val();
	$.ajax({
		url: base_url + "/admin/getProductCategoryMenuBuilderData?search="+search+"&lan="+main_menu_lan+"&id="+main_menu_id,
		success:function(data){
			$('#product_category_menu_builder_id').html(data);
			onProductCategoryCheckAll();
		}
...
function onBlogCategoryMenuBuilderPagination(page) {
	...
	$.ajax({
		url: base_url + "/admin/getBlogCategoryMenuBuilderData?page="+page+"&lan="+main_menu_lan+"&id="+main_menu_id+"&search="+search,
		success:function(data){
...
function onBlogCategoryMenuBuilderSearch() {
	var search = $("#search_blog_category_menu").val();
	$.ajax({
		url: base_url + "/admin/getBlogCategoryMenuBuilderData?search="+search+"&lan="+main_menu_lan+"&id="+main_menu_id,
		success:function(data){
			$('#blog_category_menu_builder_id').html(data);
			onBlogCategoryCheckAll();
		}
...
function onAjaxMakeMenuList() {
	...
	$.ajax({
		url: base_url + "/admin/ajaxMakeMenuList?lan="+main_menu_lan+"&id="+main_menu_id,
		success:function(data){
...
function onEditMegaMenuTitle(id) {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getMegaMenuTitleById',
		data: 'id='+id,
		success: function (response) {
...
function onUpdateMegaMenuTitle() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/UpdateMegaMenuTitle',
