			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('admin.partials.blog_table')
						</div>
					</div>
					<!--/Data grid/-->
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="tp-upload-field">
											<input type="file" name="image" id="category_thumbnail" class="form-control" readonly>
										</div>
										<em>Recommended image size width: 1200px and height: 600px.</em>
										<div id="remove_category_thumbnail" class="select-image">
											<div class="inner-image" id="view_category_thumbnail"></div>
											<a id="removeImageBtn" class="media-image-remove" href="javascript:void(0);"><i class="fa fa-remove"></i></a>
										</div>
									</div>
								</div>
...
<script src="{{asset('admin/pages/blogs.js')}}"></script>
@endpush