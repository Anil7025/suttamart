	...
	<table class="table table-borderless table-theme" style="width:100%;">
		<thead>
			<tr>
				...
				<th class="text-center" style="width:5%">{{ __('Image') }} </th>
		...
		<tbody>
			...
			<tr>
				...
				@if ($row->image != '')
				<td class="text-center"><div class="table_col_image"><img src="{{ asset('uploads/sellers/' . $row->image) }}" /></div></td>
				@else
				<td class="text-center"><div class="table_col_image"><img src="{{ asset('public') }}/admin/images/album_icon.png" /></div></td>
				@endif
