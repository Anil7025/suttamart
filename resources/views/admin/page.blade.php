				...
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="page_datalist">
							@include('admin.partials.page_table')
						</div>
					</div>
					<!--/Data grid/-->
					...
					<div id="form-panel" class="card-body dnone">
						<form novalidate="" data-validate="parsley" action="{{route('admin.savePageData')}}" id="DataEntry_formId" enctype="multipart/form-data" method="post">
							@csrf
							<div class="row">
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group tpeditor">
										<label for="sortcontent">{{ __('Sort Description') }}<span class="red">*</span></label>
										<textarea name="sortcontent" id="sortcontent" class="form-control parsley-validated" data-required="true" rows="2"></textarea>
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="image">{{ __('Page Image') }}<span class="red">*</span></label>
										<input type="file" name="image" id="image" class="form-control">
										<em>Recommended image size: 900x600px.</em>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row tabs-footer mt-15">
								<div class="col-lg-12">
									<button type="submit" class="btn blue-btn mr-10">{{ __('Save') }}</button>
...
<script src="{{asset('admin/pages/page.js')}}"></script>
@endpush