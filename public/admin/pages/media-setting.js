...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getMediaSettingsTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getMediaSettingsTableData",
		success:function(data){
			$('#media_settings_datalist').html(data);
		}
	});
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getMediaSettingsTableData?search="+search,
		success:function(data){
			$('#media_settings_datalist').html(data);
		}
	});
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/MediaSettingsUpdate',
...
function onMediaSettingsEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getMediaSettingsById',
		data: 'id=' + RecordId,
		success: function (response) {
