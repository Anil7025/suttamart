			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div class="card-body">
						...
						<div id="tp_datalist">
							@include('admin.partials.transactions_table')
						</div>
					</div>
					<!--/Data grid/-->
				</div>
...
@push('scripts')
<!-- css/js -->
<link rel="stylesheet" href="{{asset('admin/bootstrap-datetimepicker/bootstrap-fonticon.css')}}">
<link rel="stylesheet" href="{{asset('admin/bootstrap-datetimepicker/bootstrap-datetimepicker.css')}}">
...
<script src="{{asset('admin/pages/transactions.js')}}"></script>
@endpush