			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('admin.partials.teams_table') 
						</div>
					</div>
					<!--/Data grid/-->
					<!--Data Entry Form-->
					<div id="form-panel" class="card-body dnone"  >
						<form method="POST" data-validate="parsley" id="DataEntry_formId" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="slug" name="slug" class="form-control parsley-validated" required >
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="designation">{{ __('Designation') }}<span class="red">*</span></label>
										<input type="text" name="designation" id="designation" class="form-control parsley-validated" required>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="facebook" id="facebook" class="form-control parsley-validated">
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="instagram" id="instagram" class="form-control parsley-validated">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="twitter" id="twitter" class="form-control parsley-validated">
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="youtube" id="youtube" class="form-control parsley-validated">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="image">{{ __('Team Photo') }}</label>
...
<script src="{{asset('admin/pages/teams.js')}}"></script>
@endpush