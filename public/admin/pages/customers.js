...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getCustomersTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getCustomersTableData",
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getCustomersTableData?search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveCustomersData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getCustomerById',
		data: 'id='+RecordId,
		success: function (response) {
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionCustomers',
