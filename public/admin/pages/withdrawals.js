...
function onPaginationDataLoad(page) {
	...
	$.ajax({
		url:base_url + "/admin/getWithdrawalsTableData?page="+page
		+"&search="+$("#search").val()
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getWithdrawalsTableData?search="+$("#search").val()
		+"&status_id="+$('#f_status_id').val(),
		success:function(data){
			$('#tp_datalist').html(data);
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveWithdrawalsData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getWithdrawalById',
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteWithdrawal',
		data: 'id='+RecordId,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
...
function onScreenshot() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveScreenshot',
...
function getScreenshot() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getScreenshotById',
...
function onDeleteScreenshot(id) {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteScreenshotById',
		data: 'id='+id,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
