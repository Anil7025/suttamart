...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getConditionsTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getConditionsTableData?search="+$("#search").val(),
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getConditionsById',
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
			$("#RecordId").val(data.id);
			$("#title").val(data.title);
			$("#sort_description").val(data.sort_description);
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteConditions',
		data: 'id='+RecordId,
		success: function (response) {
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionConditions',
