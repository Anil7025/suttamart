	...
	<table class="table table-borderless table-theme" style="width:100%;">
		<thead>
			<tr>
				...
				<th class="text-left" style="width:25%">{{ __('Name') }}</th>
				<th class="text-left" style="width:25%">{{ __('Slug') }}</th>
				<th class="text-left" style="width:20%">{{ __('designation') }} </th>
		...
		<tbody>
			...
			<tr>
				...
				@if ($row->image != '')
				<td class="text-center"><div class="table_col_image"><img src="{{ asset('uploads/teams/' . $row->image) }}" /></div></td>
				@else
