			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('admin.partials.testimonials_table') 
						</div>
					</div>
					<!--/Data grid/-->
					<!--Data Entry Form-->
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea id="description" name="description" class="form-control parsley-validated" required rows="5" cols="50"></textarea>
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<em>Recommended image size: 300px × 200px.</em>
...
<script src="{{asset('admin/pages/testimonials.js')}}"></script>
@endpush