...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getCollectionsTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getCollectionsTableData",
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getCollectionsTableData?search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveCollectionsData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getCollectionsById',
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteCollections',
		data: 'id='+RecordId,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionCollections',
