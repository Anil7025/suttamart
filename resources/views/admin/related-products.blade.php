				...
				<div class="card">
					...
					<div class="card-body tabs-area p-0">
						...
						<div class="tabs-body">
							...
							<div id="tp_datalist">
								@include('admin.partials.related_products_table')
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div id="tp_datalist_modal">
								@include('admin.partials.products_list_for_related_product')
							</div>
						</div>
					</div>
				</div>
...
<script src="{{asset('admin/pages/related-products.js')}}"></script>
@endpush