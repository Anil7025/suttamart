...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getLanguageKeywordsTableData?page="+page+"&search="+$("#search").val()+"&language_code="+$('#language_code').val(),
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getLanguageKeywordsTableData?search="+$("#search").val()+"&language_code="+$('#language_code').val(),
		success:function(data){
			$('#tp_datalist').html(data);
		}
	});
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveLanguageKeywordsData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getLanguageKeywordsById',
...
function onConfirmDelete() {
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteLanguageKeywords',
