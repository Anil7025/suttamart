...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getLabelsTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getLabelsTableData",
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getLabelsTableData?search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveLabelsData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getLabelsById',
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteLabels',
		data: 'id='+RecordId,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionLabels',
