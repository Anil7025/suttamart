	...
	<table class="table table-borderless table-theme" style="width:100%;">
		<thead>
			<tr>
				...
				<th class="text-left" style="width:30%">{{ __('Menu Name') }}</th>
				<th class="text-center" style="width:25%">{{ __('Position') }}</th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-left"><a href="{{ route('admin.menu-builder', [$row->id]) }}" title="{{ __('Customize') }}">{{ $row->menu_name }}</a></td> 
				...
				<td class="text-center">
					<div class="btn-group action-group">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a href="{{ route('admin.menu-builder', [$row->id]) }}" class="dropdown-item">{{ __('Customize') }}</a>
