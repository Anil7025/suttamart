...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getSectionManageTableData?page="+page+"&manage_type="+$('#manage_type_filter').val(),
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getSectionManageTableData?search="+$("#search").val()+"&manage_type="+$('#manage_type_filter').val(),
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveSectionManageData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getSectionManageById',
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteSectionManage',
		data: 'id='+RecordId,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionSectionManage',
