...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getLanguagesTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getLanguagesTableData",
		success:function(data){
			$('#tp_datalist').html(data);
		}
	});
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getLanguagesTableData?search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
		}
	});
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveLanguagesData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getLanguageById',
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteLanguage',
