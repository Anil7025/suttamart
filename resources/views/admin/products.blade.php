			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('admin.partials.products_table')
						</div>
					</div>
					<!--/Data grid/-->
					...
					<div id="form-panel" class="card-body dnone">
						<form novalidate="" data-validate="parsley" id="DataEntry_formId" method="post"> @csrf
							<div class="row">
								<div class="col-lg-12">
...
<script src="{{asset('admin/pages/products.js')}}"></script>
@endpush