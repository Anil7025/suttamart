			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div class="card-body tabs-area p-0">
						@include('admin.partials.theme_options_tabs_nav')
						<div class="tabs-body">
							...
							<div class="row">
								<div class="col-lg-3 mb-30">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset('admin/images/home-1.jpg')}}" />
										</div>
								...
								<div class="col-lg-3 mb-30">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset('admin/images/home-2.jpg')}}" />
										</div>
										<div class="theme-footer">
								...
								<div class="col-lg-3 mb-30">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset('admin/images/home-3.jpg')}}" />
										</div>
										<div class="theme-footer">
								...
								<div class="col-lg-3 mb-30">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset('admin/images/home-4.jpg')}}" />
										</div>
										<div class="theme-footer">
							...
							<div class="row mb-30">
								<div class="col-lg-2">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset('admin/images/full_width.jpg')}}" />
										</div>
										<div class="theme-footer">
								...
								<div class="col-lg-2">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset('admin/images/left_sidebar.jpg')}}" />
										</div>
										<div class="theme-footer">
								...
								<div class="col-lg-2">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset('admin/images/right_sidebar.jpg')}}" />
										</div>
										<div class="theme-footer">
...
<script src="{{asset('admin/pages/page_variation.js')}}"></script>
@endpush