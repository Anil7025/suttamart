...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getTestimonialsTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getTestimonialsTableData?search="+$("#search").val(),
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
        type: "POST",
        url: "/admin/saveTestimonialsData", 
        data: formData,
        processData: false, 
        contentType: false, 
        beforeSend: function () {
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getTestimonialsById',
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteTestimonials',
		data: 'id='+RecordId,
		success: function (response) {
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionTestimonials',
