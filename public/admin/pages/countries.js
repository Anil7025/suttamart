...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getCountriesTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getCountriesTableData?search="+$("#search").val(),
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveCountriesData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getCountryById',
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionCountry',
